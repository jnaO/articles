    ...
    <article id="spirograph" data-mtest="csstransforms" class="post">
      <label class="post-title">Spirograph</label>
      <div class="wrapper exp-elem">
      ...
      <dl class="post-description">
        <dt>i:</dt>
        <dd><a href="https://twitter.com/chenebu" onclick="_gaq.push(['_trackEvent', 'Social', 'spirograph', 'twitter'])" class="twitter">@chenebu</a></dd>
        <dt>inspiration:</dt>
        <dd><a onclick="_gaq.push(['_trackEvent', 'External', 'spirograph', 'inspiration'])" href="http://www.flickr.com/photos/veerles-blog/3230371629/in/photostream/">veerles spirograph</a></dd>
        <dt>Requirements:</dt>
